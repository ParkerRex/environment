 ...
 V:::::V           V:::::VA:::::::::A             I::::I
  V:::::V         V:::::VA:::::A:::::A            I::::I
   V:::::V       V:::::VA:::::A A:::::A           I::::I
    V:::::V     V:::::VA:::::A   A:::::A          I::::I
     V:::::V   V:::::VA:::::A     A:::::A         I::::I
      V:::::V V:::::VA:::::AAAAAAAAA:::::A        I::::I
       V:::::V:::::VA:::::::::::::::::::::A       I::::I
        V:::::::::VA:::::AAAAAAAAAAAAA:::::A      I::::I
         V:::::::VA:::::A             A:::::A   II::::::II
          V:::::VA:::::A               A:::::A  I::::::::I
           V:::VA:::::A                 A:::::A I::::::::I
            VVVAAAAAAA                   AAAAAAAIIIIIIIIII
   ]]
      },
      sections = {
        { section = "header" },
        ...
        -- Claude Code Agents
        {
          pane = 2,
          icon = "󰚩 ",
          desc = "Claude: AI Dev Alpha Researcher",
          padding = 1,
          key = "A",
          action = function()
            vim.fn.jobstart("tmux split-window -h 'claude \"Use the ai-dev-alpha-researcher subagent to help with my task\"'", { detach = true })
          end,
        },
        {
          pane = 2,
          icon = "󰚩 ",
          desc = "Claude: Fullstack TypeScript Engineer",
          padding = 1,
          key = "T",
          action = function()
            vim.fn.jobstart("tmux split-window -h 'claude \"Use the fullstack-typescript-engineer subagent to help with my task\"'", { detach = true })
          end,
        },
        {
          pane = 2,
          icon = "󰚩 ",
          desc = "Claude: Twitter Draft Writer",
          padding = 1,
          key = "X",
          action = function()
            vim.fn.jobstart("tmux split-window -h 'claude \"Use the twitter-draft-writer subagent to help with my task\"'", { detach = true })
          end,
        },
        {
          pane = 2,
          icon = "󰚩 ",
          desc = "Claude: UI Engineer",
          padding = 1,
          key = "U",
          action = function()
            vim.fn.jobstart("tmux split-window -h 'claude \"Use the ui-engineer subagent to help with my task\"'", { detach = true })
          end,
        },
        {
          pane = 2,
          icon = "󰚩 ",
          desc = "Claude: Workflow Automation Architect",
          padding = 1,
          key = "W",
          action = function()
            vim.fn.jobstart("tmux split-window -h 'claude \"Use the workflow-automation-architect subagent to help with my task\"'", { detach = true })
          end,
        },
        {
          pane = 2,
          icon = "󰚩 ",
          desc = "Claude: YT Transcript Summarizer",
          padding = 1,
          key = "Y",
          action = function()
            vim.fn.jobstart("tmux split-window -h 'claude \"Use the yt-transcript-summarizer subagent to help with my task\"'", { detach = true })
          end,
        },
        function()
  ...
  keys = {
    ...
    { "<leader>a", function() vim.lsp.buf.code_action() end, desc = "Code Actions", mode = { "n", "v" } },
